    ...
    <div className="card group">
      <div className="relative block overflow-hidden">
        <Link to={`/pets/${pet.id}`} className="block">
          ...
          />
          {pet.status === 'RESERVED' && (
            <span className="absolute top-3 left-3 bg-amber-500 text-white text-xs font-semibold px-2.5 py-1 rounded-full z-10">Reserved</span>
          )}
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mt-3 pt-3 border-t border-stone-100">
          ...
          <button
            ...
            onClick={(e) => { e.preventDefault(); addItem({ ...pet, itemType: 'PET' }); }}
            title="Add to cart"
