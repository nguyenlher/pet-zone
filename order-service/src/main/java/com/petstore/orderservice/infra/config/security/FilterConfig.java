...
/**
 * Custom Filter for handling authentication in Order Service
 * Authentication Strategy:
 * - /api/public/** GET : JWT Token required (view orders - user must be authenticated)
...
public class FilterConfig extends OncePerRequestFilter {
    ...
    public FilterConfig(
            ...
            @Value("${api.key:default-secret-key}") String apiKey) {
