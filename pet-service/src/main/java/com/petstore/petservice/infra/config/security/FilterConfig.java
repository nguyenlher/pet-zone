package com.petstore.petservice.infra.config.security;
...
/**
 * Custom Filter for handling authentication in Pet Service
...
public class FilterConfig extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // 1. Public read-only endpoints - No authentication required
        if (path.startsWith("/public") && "GET".equalsIgnoreCase(method)) {
            ...
            if (authHeader != null && authHeader.startsWith("Bearer ")) {
                try {
                    ...
                    log.debug("FilterConfig - Optional JWT validated for personalization");
                } catch (Exception e) {
        ...
        // 2. User action endpoints - JWT Token required
        ...
        // 3. Internal microservice endpoints - X-API-KEY required
