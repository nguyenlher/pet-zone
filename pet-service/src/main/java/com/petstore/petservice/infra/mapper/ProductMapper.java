...
public interface ProductMapper {
    ...
    ProductEntity toEntity(Product petProduct);
    
    Product toDomain(ProductEntity entity);
    
    List<ProductEntity> toEntityList(List<Product> petProducts);
    ...
    @Mapping(target = "status", expression = "java(com.petstore.petservice.domain.model.enums.ProductStatus.AVAILABLE)")
    Product toDomain(CreatePetProductRequest request);
    ...
    @Mapping(target = "createdAt", ignore = true)
    @Mapping(target = "updatedAt", ignore = true)
    void updateDomain(@MappingTarget Product petProduct, UpdatePetProductRequest request);
    
    PetProductResponse toResponse(Product petProduct);
    
    List<PetProductResponse> toResponseList(List<Product> petProducts);
}
