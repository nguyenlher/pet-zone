...
CROSS JOIN (
    VALUES 
        ('Simba', 'Anh Lông Ngắn', 'MALE', '2023-02-14'::DATE, 5.20, ARRAY['Xám', 'Xanh'], 'SHORT', 'EXCELLENT', true, 10000000.00, 'Mèo Anh lông ngắn đực 10 tháng, màu xám xanh đẹp. Tròn trịa, đáng yêu, tính cách dễ gần. Đã huấn luyện đi vệ sinh, rất sạch sẽ.', 'AVAILABLE'),
        ('Mochi', 'Munchkin', 'FEMALE', '2023-04-15'::DATE, 3.20, ARRAY['Cam', 'Trắng'], 'SHORT', 'EXCELLENT', true, 12000000.00, 'Mèo Munchkin cái 8 tháng, chân ngắn đáng yêu. Tính cách vui vẻ, hiếu động, thích khám phá. Đã tiêm phòng đầy đủ, có giấy chứng nhận.', 'AVAILABLE'),
        ...
        ('Nala', 'Xiêm', 'FEMALE', '2021-12-20'::DATE, 3.80, ARRAY['Kem', 'Nâu'], 'SHORT', 'GOOD', true, 6000000.00, 'Mèo Xiêm cái 2 tuổi, mắt xanh đẹp, thân hình thon gọn. Rất năng động và thông minh, thích giao tiếp với người. Đã tiêm phòng đầy đủ.', 'AVAILABLE'),
        ...
        ('Leo', 'Maine Coon', 'MALE', '2022-09-05'::DATE, 7.50, ARRAY['Nâu', 'Đen', 'Trắng'], 'LONG', 'EXCELLENT', true, 15000000.00, 'Mèo Maine Coon đực 1.5 tuổi, giống mèo lớn nhất thế giới. Tính cách thân thiện, dễ gần, thích chơi với trẻ em. Lông dài đẹp, sức khỏe tốt.', 'AVAILABLE'),
