...
public class StatisticsController {
    ...
    public ResponseEntity<RevenueStatsResponse> getRevenueStats(
        ...
        log.info("GET request to fetch revenue statistics: {} to {}, groupBy: {}", startDate, endDate, groupBy);
    ...
    public ResponseEntity<OrderStatsResponse> getOrderStats(
        ...
        log.info("GET request to fetch order statistics: {} to {}", startDate, endDate);
    ...
    public ResponseEntity<Page<TopPetResponse>> getTopSellingPets(
        ...
        log.info("GET request to fetch top {} selling pets", limit);
    ...
    public ResponseEntity<SalesChartResponse> getSalesChartData(
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate) {
        log.info("GET request to fetch sales chart data: {} to {}", startDate, endDate);
    ...
    public ResponseEntity<PaymentMethodStatsResponse> getPaymentMethodStats(
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate) {
        log.info("GET request to fetch payment method statistics: {} to {}", startDate, endDate);
    ...
    public ResponseEntity<Object> getCustomerStats() {
        log.info("GET request to fetch customer statistics");
